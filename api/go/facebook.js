const { InfoExtractor } = require('./_gp4_');
const { decode } = require('./decode/gp4');

class FacebookIE extends InfoExtractor {
    constructor() {
        super();
...
class FacebookPluginsVideoIE extends InfoExtractor {
    constructor() {
        super();
        this.VALID_URL = this.Reg(
            `https?:\\/\\/
...
class FacebookReelIE extends InfoExtractor {
    constructor() {
        super();
...
class FacebookAdsIE extends InfoExtractor {
    constructor() {
        super();
