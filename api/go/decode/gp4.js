const decodeMap = require("./src/decodeMap");
const regexDecode = require("./src/regexDecode");
const regexEncodeNonAscii = require("./src/regexEncodeNonAscii.js");
const encodeMap = require("./src/encodeMap");
const decodeMapLegacy = require("./src/decodeMapLegacy");
const decodeMapNumeric = require("./src/decodeMapNumeric");
const invalidReferenceCodePoints = require("./src/invalidReferenceCodePoints");
const {
    regexAstralSymbols,
    regexAsciiWhitelist,
    regexBmpWhitelist,
